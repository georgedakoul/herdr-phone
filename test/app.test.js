...
function fakeClient(overrides = {}) {
  ...
  const client = {
    ...
    kinds: record("kinds", { installed: ["claude"], all: ["claude", "codex"] }),
    startAgent: record("startAgent", { pane_id: "w1:p9", agent: { agent: "claude", agent_session: "bot" }, ready: true }),
    renameAgent: record("renameAgent", { agent: {} }),
    focusAgent: record("focusAgent", { agent: {} }),
    explainAgent: record("explainAgent", { text: "it is idle" }),
    waitAgent: record("waitAgent", { agent_status: "idle" }),
    splitPane: record("splitPane", { pane_id: "w1:p9" }),
    closePane: record("closePane", {}),
    zoomPane: record("zoomPane", { zoomed: true }),
    renamePane: record("renamePane", {}),
    runInPane: record("runInPane", {}),
    sendText: record("sendText", {}),
    paneSendKey: record("paneSendKey", { sent: ["enter"] }),
    movePane: record("movePane", {}),
    swapPanes: record("swapPanes", {}),
    resizePane: record("resizePane", {}),
    createWorkspace: record("createWorkspace", { workspace: { workspace_id: "w2" } }),
    focusWorkspace: record("focusWorkspace", {}),
    renameWorkspace: record("renameWorkspace", {}),
    closeWorkspace: record("closeWorkspace", {}),
    createTab: record("createTab", { tab: { tab_id: "w1:t9" } }),
    focusTab: record("focusTab", {}),
    renameTab: record("renameTab", {}),
    closeTab: record("closeTab", {}),
    createWorktree: record("createWorktree", { worktree: { path: "/w2" } }),
    openWorktree: record("openWorktree", {}),
